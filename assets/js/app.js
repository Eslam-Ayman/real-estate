    ...
    $localStorageProvider.set('data',{state: false});
      ...
      $routeProvider.when("/home",{
                    ...
                    .when("/mustDo",{
                      ...
                      templateUrl: "assets/contents/must.html"})
                    .when("/done",{
                      resolve:
                      {
                        "check" : function($location,$rootScope,$localStorage){ 
                      ...
                      templateUrl: "assets/contents/done.html"})
                    .when("/trash",{
                      resolve:
                      {
                        "check" : function($location,$rootScope,$localStorage){ 
                      ...
                      templateUrl: "assets/contents/trash.html"})
                    .when("/members",{
                      resolve:
                      {
                        "check" : function($location,$rootScope,$localStorage){ 
                      ...
                      templateUrl: "assets/contents/members.html"})
                    .when("/comments",{
                      resolve:
                      {
                        "check" : function($location,$rootScope,$localStorage){ 
                      ...
                      templateUrl: "assets/contents/comments.html"})
                    .when("/chat",{
                      resolve:
                      {
                        "check" : function($location,$rootScope,$localStorage){ 
                      ...
                      templateUrl: "assets/contents/chat.html"})
                    .otherwise({
                      resolve:
                      {
                        "check" : function($location,$rootScope,$localStorage){ 
